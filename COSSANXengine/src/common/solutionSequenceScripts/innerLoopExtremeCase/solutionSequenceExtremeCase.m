...
Xevaluator=XextremeCase.XprobabilisticModel.Xmodel.Xevaluator;
...
VimportantDirection=XlineData.VimportantDirectionPHY;
...
MstatePointsPhysical=XlineData.MlimitStateCoordsPHY;
...
Vg=XsimOut.getValues('Sname',SperformanceFunctionName);
