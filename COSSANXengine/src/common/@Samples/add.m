...
for k=1:2:length(varargin),
    switch lower(varargin{k})
        ...
        case {'msamplesphysicalspace'}
            ...
            assert(size(varargin{k+1},2)==length(Xs.CnamesRandomVariable), ...
            ...
            MsamplesHyperCubeAdd=zeros(size(varargin{k+1}));
            irv=0;
        ...
        case {'xsamples'}
            ...
            assert(isa(varargin{k+1},'Samples'), ...
                'openCOSSAN:Samples:add',...
                'An object of class Samples is required after the FieldName %s\nProvided object tpye %s', ...
    ...
    Vsamples(1),Vsamples(2),Vsamples(3))
