...
% PLOTCANDIDATESOLUTIONS This method plots the evolution of the objective 
% and the search variables throughout the optimization process. If the user 
% doesn't specify what extreme is to plot (e.g. the maximum of the objective),
...
if isa(Xobj.XanalysisObject,'UncertaintyPropagation')
    XUP=Xobj.XanalysisObject;
    
elseif isa(Xobj.XanalysisObject,'ExtremeCase')
    XEC=Xobj.XanalysisObject;
    
elseif isa(Xobj.XanalysisObject,'IntervalAnalysis')
    XIA=Xobj.XanalysisObject;
end
