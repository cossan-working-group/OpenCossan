...
for k=1:2:length(varargin)
    switch lower(varargin{k})
        ...
        case 'vimportantdirection'
            VimportantDirection=varargin{k+1};
...
if exist('VimportantDirection','var')
    Xobj.VimportantDirection=VimportantDirection;
end

if exist('reliabilityIndex','var')
