...
fh=figure('Position',[676 550 1268 410],'Visible',Svisible);
varargout{1}=fh;
...
for iLine=1:Xobj.NprocessedLines
    ...
    xlabel(SxLabelDistance,'FontSize',NfontSize);
    ylabel(SyLabel,'FontSize',NfontSize)
...
%     end
    ...
    xlabel(SxLabelPlane,'FontSize',NfontSize);
    ylabel(SyLabel,'FontSize',NfontSize)
    box on
    grid on
end %loop over lines
...
title(gca(fh),Stitle,'FontSize',NfontSize);
