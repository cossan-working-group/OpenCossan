...
%GlobalSensitivityUpperBound object 
%
% USAGE
% display(XOBJ)
%
...
OpenCossan.cossanDisp('-------------------------------------------------------------------',3);
OpenCossan.cossanDisp(['* Local Sensitivity                : ',class(Xobj.XlocalSensitivity)],2);
OpenCossan.cossanDisp(['* Number of Markow Chains          : ',sprintf('%i ',Xobj.Nchains)],2);
OpenCossan.cossanDisp(['* Number of samples (Markow Chain) : ',sprintf('%i ',Xobj.Nsamples)],2);
