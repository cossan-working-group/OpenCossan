classdef GlobalSensitivityRandomBalanceDesign < Sensitivity
    ...
    % See also:
    % https://cossan.co.uk/wiki/index.php/@GlobalSensitivityRandomBalanceDesign
    %
    ...
    methods
        function Xobj=GlobalSensitivityRandomBalanceDesign(varargin)
            ...
            % indices adopting Monte Carlo simulation
            %
            % Reliability Engineering & System Safety Volume 91, Issue 6, June 2006, Pages 717-727
            %
