...
for k=1:2:length(varargin)
    switch lower(varargin{k})
        case {'xoptimizationproblem'}   %extract OptimizationProblem
            assert(isa(varargin{k+1},'OptimizationProblem'),...
...
OpenCossan.setLaptime('Sdescription',['GA:' Xobj.Sdescription]);
OpenCossan.cossanDisp('Starting GeneticAlgorithms',3)
...
OpenCossan.setLaptime('Sdescription','End GA optimization');
