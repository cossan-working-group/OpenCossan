classdef StochasticProcess
    ...
    methods
            ...
            for k=1:2:length(varargin)
                switch lower(varargin{k})
                    ...
                    case {'xcovariancefunction'}
                        ...
                        assert(isa(Xobj.Xcovariancefunction,'CovarianceFunction'),'openCOSSAN:StochasticProcess:checkCovarianceFunction',...
        ...
        Xobj=display(Xobj); % show summary of Stochasic Process
        Xobj=KL_terms(Xobj,varargin);
        
        [Xsample, Xdataseries]=sample(Xobj,varargin); % Generate Samples from StochasticProcess
        
        %% Depent fields
        function Lequallyspaced=get.Lequallyspaced(Xobj)
            Lequallyspaced = isequallyspaced(Xobj.Mcoord);
        end
