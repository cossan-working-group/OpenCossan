    ...
    if ~isempty(s)
        for it=1:length(s)
            ...
            if ~isempty(tmp_format{1})
                switch lower(tmp_format{1}{1}{1})
                    ...
                    otherwise
                        ...
                        if length(Vpos)>1
                            warning('OpenCossan:injector:scan_file','Multiple fields in the injector are not allowed');
            ...
            if isempty(tmp_original{1})
                ...
                warning('OpenCossan:injector:scan_file:noOriginalField',...
                ...
                if length(tmp_original{1}{1}{1})>Nstringlength
                    warning('OpenCossan:injector:scan_file:WrongOriginalFieldLenght',...
