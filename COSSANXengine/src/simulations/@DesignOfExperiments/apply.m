...
assert(isa(Xinput,'Input'),'openCOSSAN:DesignOfExperiments:apply',...
        'an Input object is required to perform a DesignOfExperiments analysis!!!!')
...
OpenCossan.setLaptime('Sdescription','End apply@DesignOfExperiments');
