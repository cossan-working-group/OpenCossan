...
while isempty(SexitFlag)
    ...
    %assuming constant # of samples pro line
    ...
    XlsOut = LineSamplingOutput('SperformanceFunctionName',SperformanceFunctionName,...
        'VnumPointLine',length(Xobj.Vset)*ones(Nlines,1), ...
        'Vdistance',Vdistance,'VdistanceOrthogonalPlane',VdistancePlane,'XsimulationData',Xout);
    
    OpenCossan.setLaptime('Sdescription',['Export Batch #' num2str(Xobj.ibatch) ' results']);
...
OpenCossan.setLaptime('Sdescription','End apply@LineSampling');
