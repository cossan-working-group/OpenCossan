classdef Fracture < Mio
    ...
    methods
            function Xobj= Fracture(varargin)
                ...
                switch lower(varargin{k}),
                    ...
                    case 'sdescription'
                        if ischar(varargin{k+1})
                            ...
                            error('openCOSSAN:Function:Fracture',...
                    ...
                    case {'sscript'}
                        if ischar(varargin{k+1}),
                           Xobj.Sscript   = varargin{k+1}; 
                            ...
                            error('openCOSSAN:Input:Fracture',...
                    ...
                    otherwise
                        warning('openCOSSAN:Input:Fracture',...
        ...
        Nout = evaluate(Xobj,varargin) % Evaluate the covariance function
    end
