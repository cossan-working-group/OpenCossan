    ...
    methods
        ...
        function Xobj=ModeBased(varargin)
            ...
            if ~isempty(Xobj.XFullmodel) && ~isempty(Xobj.Cnamesmodalprop)
                if ~ismember(Xobj.Cnamesmodalprop{1},Xobj.XFullmodel.Coutputnames) || ...
                   ~ismember(Xobj.Cnamesmodalprop{2},Xobj.XFullmodel.Coutputnames)     
                error('openCOSSAN:ModeBased',...
            ...
            if ~isempty(Xobj.XFullmodel) && isempty(Xobj.Xmodes0)
                ...
                Vlambda = XSimOut.Tvalues.(Xobj.Cnamesmodalprop{1});
                Mphi = XSimOut.Tvalues.(Xobj.Cnamesmodalprop{2});
                Xobj.Xmodes0 = Modes('Mphi',Mphi,'Vlambda',Vlambda);
            end
