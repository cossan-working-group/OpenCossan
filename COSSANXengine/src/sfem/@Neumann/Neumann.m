%NEUMANN  Subclass of Sfem for Neumann Method
%
% $Copyright~1993-2011,~COSSAN~Working~Group,~University~of~Innsbruck,~Austria$

classdef Neumann < Sfem
    ...
    methods % Methods inheritated from the superclass
        display(Xobj);
        %constructor
        function Xobj= Neumann(varargin)
            %NEUMANN Constructor for the Neumann object
            %
            % See also:  http://cossan.cfd.liv.ac.uk/wiki/index.php/@Neumann
            %
            % $Copyright~1993-2011,~COSSAN~Working~Group,~University~of~Innsbruck,~Austria$
