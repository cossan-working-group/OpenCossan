...
%
% See Also: https://cossan.co.uk/wiki/index.php/@RBOProblem
% https://cossan.co.uk/wiki/index.php/Reliability_Based_Optimization 
%
...
% Any kind of meta model and Simulations object can be used. However, in
% this example, a Response Surface metamodel is used to define the calibration
% points as DesignOfExperiment with 2 levels factorial. A relative
% perturbation of 0.2 is defined using the property name 'Vperturbation'
% and the maximum number of local metamodel created is set by the property
% name 'NmaxLocalRBOiterations' 
%
