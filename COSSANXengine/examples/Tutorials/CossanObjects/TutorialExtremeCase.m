...
Xm=Mio('Spath',fullfile(Sfolder,'MatlabModel'),'Sfile','tipDisplacement.m',...
    'Cinputnames',{'I' 'b' 'L' 'h' 'rho' 'P' 'E'}, ...
    'Coutputnames',{'w'},'Liostructure',true);
% Construct the Evaluator
Xeval = Evaluator('Xmio',Xm,'Sdescription','myEvaluator');
...
maxTipDispl=Parameter('value',0.0074,'Sdescription','Maximum allowed displacement');
...
if LuseIntervalBoth
    ...
    XbsetStructural=BoundedSet('CXintervals',{L b h},...
...
Xperfun=PerformanceFunction('Scapacity','maxTipDispl','Sdemand','w','Soutputname','Vg1');
...
Xals = AdaptiveLineSampling('Nlines',7,'NmaxPoints',10);
...
XextremeCase = ExtremeCase('Sdescription','', ...
    ...
    'SexistingResultsPath',OpenCossan.getCossanWorkingPath,...
    'XprobabilisticModel',Xpm, ...                     % the Probabilistic Model object is mandatory here
    'XadaptiveLineSampling',Xals,...                   % the Adaptive Line Sampling object is mandatory here
    ...
