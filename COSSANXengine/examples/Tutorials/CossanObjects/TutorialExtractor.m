...
% The eighth response reads the value from the table after two lines from the
% string 'This might be a header'. The first 2 values of the table are
% extracted. This extraction is repeated 2 times.
Xresp8 = Response('Sname', 'Out8', ...
    'Sfieldformat', '%i', ...
    'Clookoutfor',{'coord in rows'}, ...
    'NrepeatAnchor',Inf,...
    'Ncolnum',17,'Nrownum',0, ...
    'Nrepeat',1, 'CSindexName',{'Time'});
Xresp9 = Response('Sname', 'Out9', ...
    'Sfieldformat', '%e%e%e', ...
    'NrepeatAnchor',Inf,...
    'Clookoutfor',{'coord in rows'}, ...
    'Ncolnum',1,'rownum',-2, ...
    'Nrepeat',Inf, 'CSindexName',{'X','Y'},'VcoordColumn',[1,3]);
