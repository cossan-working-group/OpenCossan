...
% Interval variables
H=Interval('Sdescription','Beam Height','lowerBound',10,'upperBound',50);
W=Interval('Sdescription','Beam Width','lowerBound',10,'upperBound',50);
% Create the corresponding bounded set
Xbset=BoundedSet('Sdescription','Interval set of beam sizes',...
    'CXmembers',{H,W},...
    'CSmembers',{'H','W'});
display(Xbset)
...
Xinput=Input('CXmembers',{Xbset L},'Csmembers',{'Xbset' 'L'});
%% Interval analysis
SmodelType='mio';
