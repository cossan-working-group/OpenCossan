%% Tutorial BUILDING FRAME WITH DAMPERS (Opensees)
% 
%
...
%% Initialise OpenCossan and define the local workfolder
OpenCossan('SworkingPath',fullfile(pwd,'workfolder'))

% Initialise ssh connection with remote machine and set the remote
% WorkFolder
SSHConnection('SsshHost','iru1.liv.ac.uk', ...
              'SsshUser',answer{1},'SsshPassword',answer{2},...
              'SremoteWorkFolder',answer{3});
%% Create the input
% accelerogram inputs
...
% identifiers. A file without identifiers, MDOF_damp.tcl, is created in the
