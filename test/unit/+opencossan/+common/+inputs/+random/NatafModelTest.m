classdef NatafModelTest < matlab.unittest.TestCase
    ...
    methods (TestMethodSetup)
        function setupRvMap(testCase)
            ...
            testCase.rvs('lognormal') = opencossan.common.inputs.random.LognormalRandomVariable();
            testCase.rvs('rayleigh') = opencossan.common.inputs.random.RayleighRandomVariable();
            testCase.rvs('weibull') = opencossan.common.inputs.random.WeibullRandomVariable();
    ...
    methods (Test, ParameterCombination='exhaustive')
        function shouldMatchPositiveCorrelation(testCase, rv1, rv2)
            s = rng(); rng(8128); % Fix random number generator
            ...
            rng(s); % Restore random number generator
        end
