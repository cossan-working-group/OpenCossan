classdef UTTutorialTurbineBladePerformCollocationAnalysis < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 19;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialTurbineBladePerformCollocationAnalysis';                                       %Enter the name of the script to be tested.
        VName       = {'Xout.Vresponsemean(1)' 'Xout.Vresponsecov(1)' 'Xout.Vresponsemean(2)' 'Xout.Vresponsecov(2)'};                                     %Enter Variable Names into cell array
        Expected    = {4112.0128 0.76565 34757.4406 0.76526};                                     %Enter the expected results into cell array
        Tolerance   = {1e-1 1e-1 1e-1 1e-1};                                     %Enter the given tolerances into cell array
