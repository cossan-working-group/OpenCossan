classdef UTTutorialTurbineBladePerformNeumannAnalysis < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 20;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialTurbineBladePerformNeumannAnalysis';                                       %Enter the name of the script to be tested.
        VName       = {'Xout.Vresponsemean' 'Xout.Vresponsecov'};                                     %Enter Variable Names into cell array
        Expected    = {0.9043 0.0942};                                     %Enter the expected results into cell array
