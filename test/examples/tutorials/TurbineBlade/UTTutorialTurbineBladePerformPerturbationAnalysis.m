classdef UTTutorialTurbineBladePerformPerturbationAnalysis < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 22;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialTurbineBladePerformPerturbationAnalysis';                                       %Enter the name of the script to be tested.
        VName       = {'Xout.Vresponsemean' 'Xout.Vresponsecov'};                                     %Enter Variable Names into cell array
        Expected    = {0.89798 0.098122};                                     %Enter the expected results into cell array
