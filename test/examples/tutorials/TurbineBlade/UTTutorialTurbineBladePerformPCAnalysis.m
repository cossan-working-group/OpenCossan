classdef UTTutorialTurbineBladePerformPCAnalysis < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 21;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialTurbineBladePerformPCAnalysis';                                       %Enter the name of the script to be tested.
        VName       = {'Xout.Vresponsemean' 'Xout.Vresponsecov'};                                     %Enter Variable Names into cell array
        Expected    = {0.9073 0.1012};                                     %Enter the expected results into cell array
