classdef UTTutorialBeam3PointBendingAbaqus < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 2;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialBeam3PointBendingAbaqus';                                       %Enter the name of the script to be tested.
