classdef UTTutorialBeam3PointBendingAnsys < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 3;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialBeam3PointBendingAnsys';                                       %Enter the name of the script to be tested.
        VName       = {'Xpf'};                                     %Enter Variable Names into cell array
        Expected    = {[0.01]};                                     %Enter the expected results into cell array
