classdef UTTutorialGOCEsatellite < matlab.unittest.TestCase                          %Enter Script name after UT
    
    properties
        TestNum     = 12;                                         %Enter Test Number
        PreTest     = {[]};                                     %Enter the names of any scripts that need to be run
                                                                %prior to performing the test into a cell array.
        Name        = 'TutorialGOCEsatellite';                                       %Enter the name of the script to be tested.
        VName       = {'XsmRBD_FREQ1.VsobolFirstIndices(1:10)''' 'XsmRBD_DiagMAC1.VsobolFirstIndices(1:10)'''};                                     %Enter Variable Names into cell array
        Expected    = {[4.1623e-04, 5.4004e-04, 1.0516e-03, 5.8427e-04 4.5886e-04,...
                        4.6985e-04, 1.1752e-03, 7.2778e-04, 5.3344e-02, 4.2141e-01] ...
                       [4.1623e-04, 5.4004e-04, 1.0516e-03, 5.8427e-04, 4.5886e-04,...
                        4.6985e-04, 1.1752e-03, 7.2778e-04, 5.3344e-02, 4.2141e-01]};                                     %Enter the expected results into cell array
        Tolerance   = {0.0001 0.0001};                                     %Enter the given tolerances into cell array
