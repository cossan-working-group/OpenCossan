...
XrvN=opencossan.common.inputs.random.NormalRandomVariable('mean',0,'std',1);
Xrvsbase = opencossan.common.inputs.random.RandomVariableSet.fromIidRandomVariables(XrvN,3);

XrvU=opencossan.common.inputs.random.UniformRandomVariable('bounds',[-0.5,0.5]);
Xrvsoff = opencossan.common.inputs.random.RandomVariableSet.fromIidRandomVariables(XrvU,3);

% Create an Input object (optional)
Xin=opencossan.common.inputs.Input('RandomVariableSet',Xrvsbase);
...
Xmkv1=opencossan.common.MarkovChain('XtargetDistribution',Xrvsbase, ...
                  'Xoffsprings',Xrvsoff, ...
...
Xmkv2=opencossan.common.MarkovChain('Xinput',Xin,'Xoffsprings',Xrvsoff,'Npoints',8);          
