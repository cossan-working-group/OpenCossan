...
Xe=opencossan.workers.ascii.Extractor('Sdescription','Extractor for plate.f06', ...
    'Srelativepath','./', ...
    'Sfile','plate.f06',...
    'Xresponse',[Xresp1]);
...
Xc=opencossan.workers.Connector('SpredefinedType','nastran_x86_64','Sworkingdirectory','/tmp/',...
