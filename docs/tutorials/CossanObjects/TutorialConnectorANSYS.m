...
x1_diam1  = opencossan.common.inputs.random.NormalRandomVariable('mean',25,'std',5);      %outer diameter - 1
x2_diam2  = opencossan.common.inputs.random.NormalRandomVariable('mean',12.5,'std',2.5);       %outer diameter - 2

% Definition of Set of RandomVariable's
Cmems       = {'x1_diam1'; 'x2_diam2'};
Xrvs        = opencossan.common.inputs.random.RandomVariableSet('names',Cmems,'members',[x1_diam1; x2_diam2]);
...
%% Create the Injector
SfilePath=fullfile(opencossan.OpenCossan.getRoot, ...
    'examples','Tutorials','Connector','ANSYS');

Xi=opencossan.workers.ascii.Injector('Stype','scan','Sscanfilepath',SfilePath,...
    'Sscanfilename','bike1.cossan','Sfile','bike1.txt');

%% Define extractor object
Xresp = opencossan.workers.ascii.Response(    'Sname', 'Load', ...
    'Sfieldformat', '%8f%*', ...
...
Xe=opencossan.workers.ascii.Extractor('Sdescription','Extractor for BLABLABLA', ...
