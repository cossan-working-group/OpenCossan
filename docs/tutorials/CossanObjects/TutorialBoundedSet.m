...
Xint1  = opencossan.intervals.Interval('Description','My interval variable',...
    'lowerBound',0,'upperBound',3);

% The same interval can be defined in terms of center and raidus
Xint2  = opencossan.intervals.Interval('Description','My interval variable',...
    'center',0,'radius',1);

% An interval can also be defined from a data set where in case of more
% than one interval correlation can be considered
Xint3 = opencossan.intervals.Interval('Description','Interval defined from a data set',...
