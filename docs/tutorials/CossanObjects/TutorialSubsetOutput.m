...
Xsso1 = opencossan.simulations.SubsetOutput('Sperformancefunctionname','Vg',...
    'vsubsetfailureprobability',[.1 .2 .3],'Vsubsetcov',[.1 .2 .3],...
    'VsubsetThreshold',[.1 .2 .3],'VrejectionRates',[.1 .2 .3]);


%% Invalid calls to the constructor:
% the numeric fields must all be vectors
try
    Xsso2 = opencossan.simulations.SubsetOutput('Sperformancefunctionname','Vg',...
        'Vsubsetfailureprobability',[.1 .2 .3 ;.4 .5 .3],'Vsubsetcov',[.1 .2 .3],...
        'Vrejectionrates',[.1 .2 .3],'VsubsetThreshold',[.1 .2 .3]);    
...
Xsd =  opencossan.common.outputs.SimulationData('Cnames',{'RV1'; 'RV2';'Xrv3'},...
