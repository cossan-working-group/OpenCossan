...
Xopf=opencossan.reliability.FailureProbability('pf',0.01,'variancepf',0.00001,'Nsamples',10,'Smethod','UserDefined');
...
Xsimout = opencossan.common.outputs.SimulationData('Sdescription','new output','Tvalues',T);
...
Xprobmod=PerformanceFunction('OutputName','a','Capacity','a','Demand','a'); %#ok<SNASGU>
