...
X1=opencossan.common.inputs.random.NormalRandomVariable('mean',6,'std',2,'description','First random variable');
X2=opencossan.common.inputs.random.NormalRandomVariable('mean',5,'std',3,'description','Second random variable');
...
Xinput=opencossan.common.inputs.Input('members',{Xrvset Xsum Xmax},'membersNames',{'Xrvset' 'Xsum' 'Xmax'});
...
Xmc=opencossan.simulations.MonteCarlo('Nsamples',1e5);
