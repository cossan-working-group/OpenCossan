...
XmaxSum=opencossan.common.inputs.Parameter('value',2,'Description','Maximum allowed sum of random variable');

% Definition of the Random Varibles
X1=opencossan.common.inputs.random.NormalRandomVariable('mean',0,'std',1,'Description','First random variable');
X2=opencossan.common.inputs.random.NormalRandomVariable('mean',0,'std',1,'Description','Second random variable');

Xrvset=opencossan.common.inputs.random.RandomVariableSet('names',{'X1' 'X2'},'members',[X1; X2]);
% Definition of the Function
Xsum=opencossan.common.inputs.Function('Description','Sum of RandomVariable','Expression','<&X1&>+<&X2&>');

%% Prepare Input Object
% The above prepared object can be added to an Input Object
Xinput=opencossan.common.inputs.Input('Members',{Xrvset Xsum XmaxSum},'MembersNames',{'Xrvset' 'Xsum' 'XmaxSum'});
...
Xmodel=opencossan.common.Model('Xinput',Xinput,'Xevaluator',Xevaluator);


%% Define a Probabilistic Model
% Performance Function
Xperfun = opencossan.reliability.PerformanceFunction('OutputName','Vg','Demand','Xsum','Capacity','XmaxSum');
% Define a Probabilistic Model
XprobModel=opencossan.reliability.ProbabilisticModel('Xmodel',Xmodel,'XperformanceFunction',Xperfun);
...
%% Preparation of the Evaluator
% This example used and empty Evaluator since there is nothing to be computed.
Xevaluator=workers.Evaluator;

%% Preparation of the Physical Model
% Define the Physical Model
Xmodel=common.Model('Xinput',Xinput,'Xevaluator',Xevaluator);


%% Define a Probabilistic Model
% Performance Function
Xperfun = PerformanceFunction('OutputName','Vg','Demand','Xsum','Capacity','Xmax');
% Define a Probabilistic Model
XprobModel=ProbabilisticModel('Xmodel',Xmodel,'XperformanceFunction',Xperfun);

%% Compute Reference solutions 
Xmc=simulations.MonteCarlo('Nsamples',1e4);
...
Xga=optimization.GeneticAlgorithms('Npopulationsize',5,'NmaxIterations',10,'Smutationfcn','mutationgaussian');
