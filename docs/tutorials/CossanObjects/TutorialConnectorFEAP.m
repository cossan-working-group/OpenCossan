...
%% Extractor
%  Build extractor
Xresp = opencossan.workers.ascii.Response('Sname', 'OUT1', ...
    'Sfieldformat', '%13e', ...
    'Clookoutfor',{'N o d a l   D i s p l a c e m e n t s'}, ...
    'Ncolnum',45, ...
    'Nrownum',6 );
Xe=opencossan.workers.ascii.Extractor('Sdescription','Extractor for Opatch', ...
...
Xc=opencossan.workers.Connector('SpredefinedType','Feap',...
