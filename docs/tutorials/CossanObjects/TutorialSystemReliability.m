...
Par1=opencossan.common.inputs.Parameter('value',0.5); 
Par2=opencossan.common.inputs.Parameter('value',1); 

% Definition of the uncorrelated Set of random variables 
Xrvs = opencossan.common.inputs.random.RandomVariableSet('members',[RV1; RV2],'names',{'RV1' 'RV2'});

% Define Input Object
Xin = opencossan.common.inputs.Input('members',[Xrvs; Par1; Par2],'membersnames',{'Xrvs' 'Par1' 'Par2'});
...
% Define the Models
Xmdl= common.Model('Xevaluator',Xev,'Xinput',Xin);
...
XmALLmatrix=workers.Mio('Sdescription', 'Performance function', ...
...
XpfA=PerformanceFunction('OutputName','Va','Capacity','Par1','Demand','RV1');
XpfB=PerformanceFunction('OutputName','Vb','Capacity','Par2','Demand','RV2');
