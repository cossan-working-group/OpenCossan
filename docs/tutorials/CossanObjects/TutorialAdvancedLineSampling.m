...
Xmio_model=opencossan.workers.MatlabWorker('Description', 'Matlab I-O for the performance model',...
    'Script',...
...
Xevaluator = opencossan.workers.Evaluator('Solver',Xmio_model);
...
Xperformance=opencossan.reliability.PerformanceFunction('Description','My Performance Function', 'Script','Moutput=Minput;',...
...
XprobModel=opencossan.reliability.ProbabilisticModel('Description','Defines our reliability analysis',...
    'Model',Xmodel,'PerformanceFunction',Xperformance);
