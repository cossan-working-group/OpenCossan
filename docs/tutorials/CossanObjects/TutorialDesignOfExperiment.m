...
Xrvs1 = opencossan.common.inputs.random.RandomVariableSet('names',{'RV1','RV2','RV3'},'members',[RV1;RV2;RV3]);
...
Xdoe = opencossan.simulations.DesignOfExperiments('SdesignType','BoxBehnken');
