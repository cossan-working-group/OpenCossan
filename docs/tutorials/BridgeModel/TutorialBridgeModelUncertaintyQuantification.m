...
Xlhs=simulations.LatinHypercubeSampling('Nsamples',100);
...
Mstatistics=table2array(XoutLHS.getStatistics('Sname','maxDisplacement'));
...
%% Use sobol sampling
Xss=simulations.SobolSampling('Nsamples',1000);
