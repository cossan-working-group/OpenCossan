...
%
% Implemented in the OpenCossan by Matteo Broggi
% Check by Edoado Patelli
%
% See Also http://cossan.cfd.liv.ac.uk/wiki/index.php/Truss_Structure
...
% Validate Solution
assert(abs(Xoptimum.XobjectiveFunction.Mdata(end) -  2400)<10,...the optimum is around 4000
