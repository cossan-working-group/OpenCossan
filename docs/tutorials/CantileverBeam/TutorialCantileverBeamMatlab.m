...
b = opencossan.common.inputs.Parameter('value', 0.12, 'description', 'Beam width');
maxDisplacement = opencossan.common.inputs.Parameter('value', 0.010, 'description', 'Maximum allowed displacement');

% Definition of the Random Varibles
P = opencossan.common.inputs.random.LognormalRandomVariable.fromMeanAndStd('mean', 5000, 'std', 400, 'Description', 'Load');
h = opencossan.common.inputs.random.NormalRandomVariable('mean', 0.24, 'std', 0.01, 'description', 'Beam Heigth');
rho = opencossan.common.inputs.random.LognormalRandomVariable.fromMeanAndStd('mean', 600, 'std', 140, 'description', 'density');
E = opencossan.common.inputs.random.LognormalRandomVariable.fromMeanAndStd('mean', 10e9, 'std', 1.6e9, 'description', 'Young''s modulus');
...
Xrvset = opencossan.common.inputs.random.RandomVariableSet('members', [P; h; rho; E], ...
