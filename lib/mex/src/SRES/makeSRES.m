% Script to generate mex file for Stochastic Ranking ED.
% Created by Edoardo Patelli

disp('Compiling the Stochastic Ranking ED auxiliary mex files ..');

assert(~isempty(OpenCossan.getCossanRoot),'openCOSSAN:makeSRES:errorInitialisation','Please initialize OpenCossan')
