...
NinitialRVindex=1;
for n=1:Xmkv.Nsets
    NendRVindex=Xmkv.OffSprings(n).Nrv+NinitialRVindex-1;
    
    MX_pert = sample(Xmkv.OffSprings(n),Xmkv.Samples(1).Nsamples);   
    ...
    [~, Mrvi]=evalpdf(Xmkv.Base(n),'Musamples', Mxi);
    [~, Mrv0]=evalpdf(Xmkv.Base(n),'Musamples', MUlast);
    ...
    XsTmp=Samples('Msamplesstandardnormalspace',MU,'Xrvset',Xmkv.Base(n));
