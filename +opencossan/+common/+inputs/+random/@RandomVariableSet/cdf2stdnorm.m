function MS = cdf2stdnorm(obj,values)
    
    %  cdf2stdnorm maps a point of the hypercube to standard normal space of the random variables
    %  included in the RandomVariableSet object.
    %
    %
    %  MANDATORY ARGUMENTS
    %    - RVS:  object of RandomVariableSet - MU:   Matrix of samples of RV hypercube
    %
    %  OUTPUT ARGUMENTS:
    ...
    if istable(values)
        MS = array2table(MS);
        MS.Properties.VariableNames = obj.Names;
    end
end
