function MY = physical2cdf(obj,values)
    %  PHYSICAL2CDF maps a point of the physical space to the hypercube of the random variables
    %  included in the RandomVariableSet object.
    %
    %  MANDATORY ARGUMENTS
    %    - obj:  object of RandomVariableSet - MX:   Matrix of realizations of RandomVariable in
    %    physical space
    %
    %  OUTPUT ARGUMENTS:
    ...
    if istable(values)
        MY = array2table(MY);
        MY.Properties.VariableNames = obj.Names;
    end
