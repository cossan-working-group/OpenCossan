function varargout = plot1Ddensity(Xobj,varargin)
%plot2Ddensity  Plot 1D density of the GaussianRandomVariableSet
...
assert (Xobj.Nrv>1,...
    ...
    'The 1D plot can not be displyed because the object contains does not contains variables')
