...
for n=1:length(Cnames)
    ...
    if any(fail_col==n)
        ...
        for ifail = Vfail
            Cdataseries{fail_row(ifail),n} = Dataseries('Sdescription',Cdataseries{success_row,n}.Sdescription,...
                'CSindexName',Cdataseries{success_row,n}.CSindexName,...
                'CSindexUnit',Cdataseries{success_row,n}.CSindexUnit,...
    ...
    if all(Msizes==repmat(Msizes(1,:),size(Msizes,1),1))
        ...
        Cout{n}=Dataseries('Sdescription',Cdataseries{1,n}.Sdescription,...
            'CSindexName',Cdataseries{1,n}.CSindexName,...
            'CSindexUnit',Cdataseries{1,n}.CSindexUnit,...
