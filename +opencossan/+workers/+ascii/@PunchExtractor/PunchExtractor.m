classdef PunchExtractor < opencossan.workers.ascii.Extractor
    ...
    methods
        function Xobj  = PunchExtractor(varargin)
            ...
            if exist(fullfile(Xobj.Sworkingdirectory,Xobj.Srelativepath,Xobj.Sfile),'file') ~= 2
                error('openCOSSAN:PunchExtractor',['Please make sure that the input file ' Xobj.Sfile ' exists']);
            end
