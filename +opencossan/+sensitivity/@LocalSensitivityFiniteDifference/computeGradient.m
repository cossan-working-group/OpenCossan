function varargout=computeGradient(Xobj,varargin)
...
for k=1:2:length(varargin)
    switch lower(varargin{k})
        ...
        case {'cxtarget','cxmodel'}
            Xobj=Xobj.addModel(varargin{k+1}{1});
        otherwise
            error('openCOSSAN:LocalSensitivityFiniteDifference:computeGradient:WrontInputArgument',...
...
% set the analyis ID 
% opencossan.OpenCossan.setAnalysisID;
