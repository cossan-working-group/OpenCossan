            ...
            for k=1:2:length(varargin),
                switch lower(varargin{k}),
                    ...
                    case 'ccxobjectivefunctions'
                        for n=1:length(varargin{k+1})
                            assert(isa(varargin{k+1}{n}{:},'optimization.ObjectiveFunction'), ...
                                'openCOSSAN:RobustDesign',...
                                'CXobjectivefunctions must contains only ObjectiveFunction Objects ');
                            if n==1
                                Xobj.XobjectiveFunction= varargin{k+1}{n}{:};
                    ...
                    case 'xmetamodel'
                        ...
                        assert(strcmp(XmetaData.SuperClasses{1}.Name,'opencossan.metamodels.MetaModel'), ...
                            'openCOSSAN:RobustDesign',...
                    ...
                    case 'xinnerloopmodel'
                        assert(isa(varargin{k+1},'opencossan.common.Model'), ...
                            'openCOSSAN:RobustDesign',...
                    ...
                    case {'cxinnerloopmodel' 'cxmodel'}
                        assert(isa(varargin{k+1}{1},'opencossan.common.Model'), ...
                            'openCOSSAN:RobustDesign',...
                    ...
                    case 'xsimulator'
                        assert(isa(varargin{k+1},'opencossan.simulations.MonteCarlo')|...
                    ...
                    case 'cxsimulator'
                        assert(isa(varargin{k+1}{1},'opencossan.simulations.MonteCarlo')|...
