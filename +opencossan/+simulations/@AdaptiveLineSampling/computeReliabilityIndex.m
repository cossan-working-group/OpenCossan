function [Xobj,XsimOut,reliabilityIndex,Tline,stateFlag0,NevalPoints,XsamplesInput]=computeReliabilityIndex(Xobj,Xtarget)
...
[~,Tline,XsimOut,XsamplesInput]=...
    exploitLine(Xobj,Xtarget,...
    'reliabilityIndex',0,...
    'VhyperPlanePoint',zeros(length(Xobj.VdirectionSNS),1));
