...
opencossan.OpenCossan.cossanDisp(['* iteration: ' num2str(Xobj.Niterations)],3)
opencossan.OpenCossan.cossanDisp(['* criterion: ' Xobj.Scriterion],3)
opencossan.OpenCossan.cossanDisp(['* smooth: ' Xobj.Ssmooth],3)
