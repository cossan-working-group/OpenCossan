...
Smarker='-';
Svisible='on';
NplotLevels=length(Xobj.subsetFailureProbability);
...
scatter(ones(Xobj.initialSamples,1),Vg(1:Xobj.initialSamples))
hold

scatter(ilevel*ones(Xobj.initialSamples,1),Vg(reshape(Xobj.chainIndices(:,:,1),1,[])),'r')
...
for n=1:NplotLevels
                ...
                %figure
                scatter(MU,Xobj.subsetPerformance,'ob'),hold on,                
