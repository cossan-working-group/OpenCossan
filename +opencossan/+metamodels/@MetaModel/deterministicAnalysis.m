...
OpenCossan.setLaptime('description','[MetaModel deterministicAnalysis] Start model evaluation')
% set the analyis ID
...
OpenCossan.setLaptime('description','[MetaModel deterministicAnalysis] Stop model evaluation')
