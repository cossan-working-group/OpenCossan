classdef NeuralNetwork < opencossan.metamodels.MetaModel
        ...
        function Xobj=NeuralNetwork(varargin)
            ...
            for k=1:2:nargin
                switch lower(varargin{k})
                    ...
                    case{'xcalibrationdata','cxsimcalibration'}    
                        Xobj.XcalibrationData  = varargin{k+1};
                        assert(isa(Xobj.XcalibrationData,'opencossan.common.outputs.SimulationData'), ...
                            'openCOSSAN:NeuralNetwork',...
                            'PropertyName %s must be an object of type SimulationData',varargin{k});
                     case{'tcalibrationdata'}
                            Xobj.TcalibrationData  = varargin{k+1};    
                    case{'tvalidationdata'}
