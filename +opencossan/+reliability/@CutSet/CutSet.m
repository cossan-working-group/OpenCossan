        ...
        function Xobj=CutSet(varargin)
            ...
            for k=1:2:length(varargin)
                switch lower(varargin{k})
                    case {'xfaulttree'}
                        if isa(varargin{k+1},'opencossan.reliability.FaultTree')
                    ...
                    case {'xdesignpoint','xdesignpoints'}
                        if isa(varargin{k+1},'opencossan.reliability.DesignPoint')
                    ...
                    case {'xfailureprobability'}
                        if isa(varargin{k+1},'opencossan.reliability.FailureProbability')
