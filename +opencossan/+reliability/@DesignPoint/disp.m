...
%   Physical space
OpenCossan.cossanDisp(['** in physical space    : ' sprintf('%10.3e ',Xo.VDesignPointPhysical)],1);
...
%   Physical space
OpenCossan.cossanDisp(['** in physical space    : ' sprintf('%10.3e ',Xo.VDirectionDesignPointPhysical)],1);

%% 4.   Euclidean norm
OpenCossan.cossanDisp(['* Euclidean norm of the Design Point ' sprintf('%10.3e ',Xo.ReliabilityIndex)],2);
