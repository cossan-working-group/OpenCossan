            ...
            for k=1:2:length(varargin)
                switch lower(varargin{k})
                    ...
                    case {'xfaulttree','cxfaulttree'}
                        ...
                        assert(isa(Xobj.XFaultTree,'opencossan.reliability.FaultTree'),...
                    ...
                    case {}
                        assert(isa(varargin{k+1}(1),'opencossan.reliability.PerformanceFunction'),...
                            'openCOSSAN:SystemReliability',...
                    ...
                    case {'cxperformancefunctions','xperformancefunctions'}
                        ...
                        assert(isa(Xobj.XperformanceFunctions(1),'opencossan.reliability.PerformanceFunction'),...
                            'openCOSSAN:SystemReliability',...
                    ...
                    case {'xmodel','cxmodel'}
                        ...
                        assert(isa(Xobj.Xmodel,'opencossan.common.Model'),...
                            'openCOSSAN:SystemReliability',...
                            'An object of type %s is not valid after the PropertyName %s', ...
